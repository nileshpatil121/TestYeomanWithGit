...
;
/*
 * AngularJS v1.2.19 (c) 2010-2014 Google, Inc. http://angularjs.org License:
 * MIT
 */
(function(T, V, s) {
    'use strict';
    ...
    function v(b) {
        return function() {
            var a = arguments[0],
                c, a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.2.19/" + (b ? b + "/" : "") + a;
    ...
    function Ga(b, a, c, d) {
        ...
        if (a) {
            ...
            if (L(b))
                for (var g = a.length = 0; g < b.length; g++) e = Ga(b[g], null, c, d), U(b[g]) && (c.push(b[g]), d.push(e)), a.push(e);
            else {
                var f = a.$$hashKey;
                q(a, function(b, c) {
                    delete a[c]
                });
                for (g in b) e = Ga(b[g], null, c, d), U(b[g]) && (c.push(b[g]), d.push(e)), a[g] = e;
                Xb(a, f)
            }
        } else(a = b) && (L(b) ? a = Ga(b, [], c, d) : Oa(b) ? a = new Date(b.getTime()) : fb(b) ? a = RegExp(b.source) : U(b) && (a = Ga(b, {}, c, d)));
        return a
    }
    ...
    function la(b, a) {
        if (L(b)) {
            ...
            for (c in a = a || {}, b) !yb.call(b, c) || "$" === c.charAt(0) && "$" === c.charAt(1) || (a[c] = b[c]);
        return a || b
    }
        ...
        if (c == typeof a && "object" == c)
            if (L(b)) {
                ...
                if (b && b.$evalAsync && b.$watch || a && a.$evalAsync &&
                    a.$watch || Ea(b) || Ea(a) || L(a)) return !1;
                c = {};
                for (d in b)
                    if ("$" !== d.charAt(0) && !O(b[d])) {
                        if (!ya(b[d], a[d])) return !1;
    ...
    function Wc(b, a) {
        var c = a;
        "string" === typeof b && "$" === b.charAt(0) ? c = s : Ea(a) ? c = "$WINDOW" : a && V === a ? c = "$DOCUMENT" : a && (a.$evalAsync && a.$watch) && (c = "$SCOPE");
        return c
    }
    ...
    function bc(b) {
        ...
        q((b || "").split("&"), function(b) {
            b && (c = b.split("="), d = ac(c[0]), B(d) && (b = B(c[1]) ? ac(c[1]) : !0, a[d] ? L(a[d]) ? a[d].push(b) : a[d] = [a[d], b] : a[d] = b))
        });
        return a
    }
    ...
    function cc(b, a) {
        ...
        if (T && !d.test(T.name)) return c();
        T.name = T.name.replace(d, "");
            ...
            if (!d || null != b)
                for (; e.length;)
                    for (h = e.shift(), l = 0, p = h.length; l < p; l++)
                        for (n = x(h[l]), m ? n.triggerHandler("$destroy") : m = !m, r = 0, n = (t = n.children()).length; r < n; r++) e.push(Ca(t[r]));
    ...
    function S(b) {
        ...
        if (y(b)) {
            ...
            Hb(this, b);
            x(V.createDocumentFragment()).append(this)
        } else Hb(this, b)
    }
    ...
    function lc(b, a, c, d) {
        ...
        var e = ma(b, "events");
        ma(b, "handle") && (D(a) ? q(e, function(a, c) {
            Xa(b, c, a);
            delete e[c]
        }) : q(a.split(" "), function(a) {
            D(c) ? (Xa(b, a, e[a]), delete e[a]) : Qa(e[a] || [], c)
        }))
    }
    ...
    function te(b, a, c, d) {
        ...
        function f() {
            z = null;
            K != k.url() && (K = k.url(), q(ha, function(a) {
                a(k.url())
            }))
        }
        var k = this,
        ...
        k.url = function(a, c) {
            ...
            if (a) {
                if (K != a) return K = a, d.history ? c ? l.replaceState(null, "", a) : (l.pushState(null, "", a), Q.attr("href", Q.attr("href"))) : (z = a, c ? h.replace(a) : h.href = a), k
        ...
        k.cookies = function(a, b) {
            ...
            if (a) b === s ? m.cookie = escape(a) + "=;path=" + C + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : y(b) && (d = (m.cookie = escape(a) + "=" + escape(b) + ";path=" + C).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!"));
                ...
                if (m.cookie !== ca)
                    for (ca = m.cookie,
                        d = ca.split("; "), M = {}, g = 0; g < d.length; g++) e = d[g], k = e.indexOf("="), 0 < k && (a = unescape(e.substring(0, k)), M[a] === s && (M[a] = unescape(e.substring(k + 1))));
                return M
            }
        };
            ...
            function b(b, d) {
                ...
                return a[b] = {
                    put: function(a, b) {
                        ...
                        if (!D(b)) return a in m || f++, m[a] = b, f > h && this.remove(n.key), b
                    },
                    get: function(a) {
                        if (h < Number.MAX_VALUE) {
                            var b = l[a];
    ...
    function fc(b, a) {
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(a, b, l, p, n, r, t, J, w, u, K, Q) {
            ...
            function N(a, b, c, d, e, g) {
                ...
                for (var m = [], h, l, r, p, n = 0; n < a.length; n++) h = new Kb, l = ca(a[n], [], h, 0 === n ? d : s, e), (g = l.length ? H(l, a[n], h, b, c, null, [], [], g) : null) && g.scope && ha(x(a[n]), "ng-scope"), h = g && g.terminal || !(r = a[n].childNodes) || !r.length ?
            ...
            function ca(a, b, c, d, f) {
                ...
                switch (a.nodeType) {
                    case 1:
                        ba(b, na(La(a).toLowerCase()), "E", d, f);
                        ...
                        a = a.className;
                        if (y(a) && "" !== a)
                            for (; m = g.exec(a);) l = na(m[2]), ba(b, l, "C", d, f) && (c[l] = aa(m[3])), a = a.substr(m.index + m[0].length);
                        break;
                    case 3:
                        v(b, a.nodeValue);
                        break;
                    case 8:
                        try {
                            if (m = e.exec(a.nodeValue)) l = na(m[1]), ba(b, l, "M",
                                d, f) && (c[l] = aa(m[2]))
                        } catch (z) {}
                }
                b.sort(D);
            ...
            function H(a, c, d, e, g, f, m, p, n) {
                ...
                function J(a, b, c, d) {
                    ...
                    if (y(b)) {
                        for (;
                            "^" == (e = b.charAt(0)) || "?" == e;) b = b.substr(1), "^" == e && (g = "inheritedData"), f = f || "?" == e;
                        e = null;
                        d && "data" === g && (e = d[b]);
                ...
                function K(a, e, g, f, n) {
                    ...
                    var u, R, z, Q, G, C, ca = {},
                        mb;
                    u = c === g ? d : la(d, new Kb(x(g), d.$attr));
                    R = u.$$element;
                    if (M) {
                        var ba = /^\s*([@=&])(\??)\s*(\w*)\s*$/;
                        f = x(g);
                    ...
                    N && q(N, function(a) {
                        ...
                        c = t(G, b);
                        ca[a.name] = c;
                        Da || R.data("$" + a.name + "Controller", c);
                        a.controllerAs && (b.$scope[a.controllerAs] = c)
                    });
                    f = 0;
                    for (z = m.length; f < z; f++) try {
                        Q = m[f], Q(Q.isolateScope ? C : e, R, u, Q.require && J(Q.directiveName, Q.require, R, ca), mb)
                    } catch (F) {
                        l(F, ga(R))
                    }
                    f = e;
                    ...
                    for (f = p.length - 1; 0 <= f; f--) try {
                        Q = p[f], Q(Q.isolateScope ? C : e, R, u, Q.require && J(Q.directiveName, Q.require, R, ca), mb)
                    } catch (B) {
                        l(B, ga(R))
                    }
                }
                n = n || {};
                for (var u = -Number.MAX_VALUE, Q, N = n.controllerDirectives, M = n.newIsolateScopeDirective, H = n.templateDirective, ba = n.nonTlbTranscludeDirective, D = !1, E = !1, Da = n.hasElementTranscludeDirective, v = d.$$element = x(c), F, oa, X, T = e, S, P = 0, pa = a.length; P < pa; P++) {
                    F = a[P];
                    var W = F.$$start,
                        Y = F.$$end;
                    W && (v = C(c, W, Y));
                    X = s;
                    if (u > F.priority) break;
                    if (X = F.scope) Q = Q || F, F.templateUrl || (I("new/isolated scope", M, F, v), U(X) && (M = F));
                    oa = F.name;
                    !F.templateUrl && F.controller && (X = F.controller, N = N || {}, I("'" + oa + "' controller", N[oa], F, v), N[oa] = F);
                    if (X = F.transclude) D = !0, F.$$tlb || (I("transclusion", ba, F, v), ba = F), "element" == X ? (Da = !0, u = F.priority, X = C(c, W, Y), v = d.$$element = x(V.createComment(" " + oa + ": " + d[oa] + " ")), c = v[0], nb(g, x(za.call(X, 0)), c), T = z(X, e, u, f && f.name, {
                        nonTlbTranscludeDirective: ba
                    })) : (X = x(Ib(c)).contents(), v.empty(), T = z(X, e));
                    if (F.template)
                        if (E = !0, I("template", H, F, v), H = F, X = O(F.template) ? F.template(v, d) : F.template, X = Z(X), F.replace) {
                            f = F;
                            X = Gb.test(X) ? x(aa(X)) : [];
                            c = X[0];
                            if (1 != X.length || 1 !== c.nodeType) throw ia("tplrt", oa, "");
                            nb(g, v, c);
                            pa = {
                                $attr: {}
                            };
                            X = ca(c, [],
                                pa);
                            var ue = a.splice(P + 1, a.length - (P + 1));
                            M && sc(X);
                            a = a.concat(X).concat(ue);
                            B(d, pa);
                            pa = a.length
                        } else v.html(X);
                    if (F.templateUrl) E = !0, I("template", H, F, v), H = F, F.replace && (f = F), K = A(a.splice(P, a.length - P), v, d, g, D && T, m, p, {
                        ...
                        S = F.compile(v, d, T), O(S) ? w(null, S, W, Y) : S && w(S.pre, S.post, W, Y)
                    } catch ($) {
                        l($, ga(v))
                    }
                    F.terminal && (K.terminal = !0, u = Math.max(u, F.priority))
                }
                K.scope = Q && !0 === Q.scope;
                K.transcludeOnThisElement = D;
            ...
            function sc(a) {
                for (var b = 0, c = a.length; b < c; b++) a[b] = Yb(a[b], {
                    $$isolateScope: !0
                })
            }

            function ba(b, e, g, f, h, r, p) {
                if (e === h) return null;
                h = null;
                if (c.hasOwnProperty(e)) {
                    ...
                    for (var t = 0, w = e.length; t < w; t++) try {
                        n = e[t], (f === s || f > n.priority) && -1 != n.restrict.indexOf(g) && (r && (n = Yb(n, {
                            $$start: r,
                            $$end: p
                        })), b.push(n), h = n)
                    } catch (J) {
            ...
            function A(a, b, c, d, e, g, f, m) {
                var h = [],
                    ...
                    K = O(w.templateUrl) ? w.templateUrl(b,
                        c) : w.templateUrl;
                b.empty();
                p.get(u.getTrustedResourceUrl(K), {
                    ...
                    if (w.replace) {
                        p = Gb.test(p) ? x(aa(p)) : [];
                        n = p[0];
                        if (1 != p.length || 1 !== n.nodeType) throw ia("tplrt", w.name, K);
                        p = {
                            $attr: {}
                        };
                        nb(d, b, n);
                    ...
                    for (r = N(b[0].childNodes, e); h.length;) {
                        ...
                        u = l.transcludeOnThisElement ? M(p, l.transclude, G) : G;
                        l(r, p, z, d, u)
                    }
                    h = null
            ...
            function S(a, c, d, e) {
                ...
                if (g) {
                    if ("multiple" ===
                        e && "SELECT" === La(a)) throw ia("selmulti", ga(a));
                    c.push({
                        priority: 100,
                        compile: function() {
                            return {
                                pre: function(c, d, m) {
                                    ...
                                    if (g = b(m[e], !0, T(a, e))) m[e] = g(c), (d[e] || (d[e] = [])).$$inter = !0, (m.$$observers && m.$$observers[e].$$scope || c).$watch(g, function(a, b) {
                ...
                if (a)
                    for (f = 0, m = a.length; f < m; f++)
                        if (a[f] == d) {
                            ...
                            m = f + e - 1;
                            for (var h =
                                    a.length; f < h; f++, m++) m < h ? a[f] = a[m] : delete a[f];
                            a.length -= e - 1;
                            break
                        }
            ...
            Kb.prototype = {
                ...
                $set: function(a, b, c, d) {
                    ...
                    e = La(this.$$element);
                    if ("A" === e && "href" === a || "IMG" === e && "src" === a) this[a] = b = Q(b, "src" === a);
            ...
            var Da = b.startSymbol(),
                pa = b.endSymbol(),
                Z = "{{" == Da || "}}" == pa ? Fa : function(a) {
                    return a.replace(/\{\{/g, Da).replace(/}}/g, pa)
                },
                W = /^ngAttr[A-Z]/;
            return z
        }]
    ...
    function Ud() {
        var b = /^\s*(\[|\{[^\{])/,
            ...
            e = this.defaults = {
                ...
                transformRequest: [function(a) {
                    return U(a) && "[object File]" !== xa.call(a) && "[object Blob]" !== xa.call(a) ? sa(a) : a
                }],
                headers: {
                    common: {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(a, b, c, d, p, n) {
            function r(a) {
                ...
                for (q(u, function(a) {
                        (a.request ||
                            a.requestError) && g.unshift(a.request, a.requestError);
            ...
            function t(c, g, f) {
                function h(a, b, c, e) {
                    G && (200 <= a && 300 > a ? G.put(x, [a, b, vc(c), e]) : G.remove(x));
                    n(b, a, c, e);
                    d.$$phase || d.$apply()
                }
                ...
                function t() {
                    var a = Pa(r.pendingRequests, c); - 1 !== a && r.pendingRequests.splice(a, 1)
                }
                var u = p.defer(),
                    q = u.promise,
                    G, H, x = J(c.url, c.params);
                r.pendingRequests.push(c);
                q.then(t, t);
                (c.cache || e.cache) && (!1 !== c.cache && "GET" == c.method) && (G = U(c.cache) ? c.cache : U(e.cache) ? e.cache : w);
                if (G)
                    if (H = G.get(x), B(H)) {
                        if (H.then) return H.then(t, t), H;
                        L(H) ? n(H[1], H[0], la(H[2]), H[3]) : n(H, 200, {}, "OK")
                    } else G.put(x, q);
                D(H) && ((H =
                    Lb(c.url) ? b.cookies()[c.xsrfCookieName || e.xsrfCookieName] : s) && (f[c.xsrfHeaderName || e.xsrfHeaderName] = H), a(c.method, x, g, h, f, c.timeout, c.withCredentials, c.responseType));
                return q
            }
            ...
            function J(a, b) {
                ...
                var c = [];
                Tc(b, function(a, b) {
                    null === a || D(a) || (L(a) || (a = [a]), q(a, function(a) {
                        U(a) && (a = sa(a));
                        c.push(Aa(b) + "=" + Aa(a))
                    }))
                });
    ...
    function we(b) {
        if (8 >= P && (!b.match(/^(get|post|head|put|delete|options)$/i) || !T.XMLHttpRequest)) return new T.ActiveXObject("Microsoft.XMLHTTP");
    ...
    function xe(b, a, c, d, e) {
        ...
        return function(e, m, h, l, p, n, r, t) {
            ...
            if ("jsonp" == I(e)) {
                ...
                var Q = g(m.replace("JSON_CALLBACK", "angular.callbacks." + K), K, function(a, b) {
                    w(l, a, d[K].data, "", b);
                    d[K] = A
                })
            } else {
    ...
    function Sd() {
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce", function(c, d, e) {
            function g(g, h, l) {
                for (var p, n, r = 0, t = [], J = g.length, w = !1, u = []; r < J;) - 1 != (p = g.indexOf(b, r)) && -1 != (n = g.indexOf(a, p + f)) ? (r != p && t.push(g.substring(r, p)), t.push(r = c(w = g.substring(p +
                    f, n))), r.exp = w, r = n + k, w = !0) : (r != J && t.push(g.substring(r)), r = J);
                    ...
                    try {
                        for (var b = 0, c = J, f; b < c; b++) {
                            if ("function" == typeof(f = t[b]))
                                if (f = f(a), f = l ? e.getTrusted(l, f) : e.valueOf(f), null == f) f = "";
        ...
        this.$get = ["$rootScope", "$window", "$q", function(b, a, c) {
            ...
            d.cancel = function(b) {
                return b && b.$$intervalId in e ? (e[b.$$intervalId].reject("canceled"),
                    a.clearInterval(b.$$intervalId), delete e[b.$$intervalId], !0) : !1
            };
            return d
        }]
    }
    ...
    function zc(b, a, c) {
        ...
        a.$$host = b.hostname;
        a.$$port = Z(b.port) || ye[b.protocol] || null
    }
    ...
    function Bc(b, a) {
        ...
        this.$$rewrite = function(d) {
            var e;
            if ((e = qa(b, d)) !== s) return d = e, (e = qa(a, e)) !== s ? c + (qa("/", e) || e) : b + d;
            if ((e = qa(c, d)) !== s) return c + e;
            if (c == d + "/") return c
        }
    }
    ...
    function Wd() {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", function(c, d, e, g) {
            ...
            var k, m, h = d.baseHref(),
                l = d.url(),
                p;
            a ? (p = l.substring(0, l.indexOf("/", l.indexOf("//") + 2)) + (h || "/"), m = e.history ? Bc : Qb) : (p =
                ab(l), m = Pb);
            k = new m(p, "#" + b);
            k.$$parse(k.$$rewrite(l));
            g.on("click", function(a) {
                if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
                    ...
                    var f = e.prop("href");
                    U(f) && "[object SVGAnimatedString]" === f.toString() && (f = ta(f.animVal).href);
                    if (m === Qb) {
                        ...
                        if (0 > h.indexOf("://"))
                            ...
                            for (var l = k.path().split("/"), h = h.split("/"), n =
                                    0; n < h.length; n++) "." != h[n] && (".." == h[n] ? l.pop() : h[n].length && l.push(h[n]));
                            f = p + f + l.join("/")
                        }
                    }
                    l = k.$$rewrite(f);
                    f && (!e.attr("target") && l && !a.isDefaultPrevented()) && (a.preventDefault(), l != d.url() && (k.$$parse(l), c.$apply(), T.angular["ff-684208-preventDefault"] = !0))
                }
            });
    ...
    function da(b, a) {
        if ("__defineGetter__" === b || "__defineSetter__" === b || "__lookupGetter__" === b || "__lookupSetter__" ===
            b || "__proto__" === b) throw ja("isecfld", a);
        return b
    }
    ...
    function Dc(b, a, c, d, e, g, f) {
        ...
        return f.unwrapPromises ? function(f, m) {
            ...
            if (null == h) return s;
            (h = h[c]) &&
            h.then && (ua(g), "$$v" in h || (l = h, l.$$v = s, l.then(function(a) {
                l.$$v = a
            })), h = h.$$v);
            if (!d) return h;
            if (null == h) return s;
            ...
            if (a.unwrapPromises || 2 !== e)
                if (a.csp) g = 6 > e ? Dc(d[0], d[1], d[2], d[3], d[4], c, a) : function(b, g) {
                    var f = 0,
                        k;
                    do k =
                        Dc(d[f++], d[f++], d[f++], d[f++], d[f++], c, a)(b, g), g = s, b = k; while (f < e);
                    return k
                };
                else {
                    var f = "var p;\n";
    ...
    function Yd() {
        ...
        this.$get = ["$filter", "$sniffer", "$log", function(c, d, e) {
            a.csp = d.csp;
            ua = function(b) {
                a.logPromiseWarnings && !Fc.hasOwnProperty(b) &&
                    (Fc[b] = !0, e.warn("[$parse] Promise found in the expression `" + b + "`. Automatic unwrapping of promises in Angular expressions is deprecated."))
            };
            return function(d) {
                var e;
                switch (typeof d) {
            ...
            k.prototype = {
                ...
                $watchCollection: function(a, b) {
                    ...
                    return this.$watch(function() {
                        ...
                        if (U(d))
                            if (db(d))
                                for (e !== l && (e = l, q = e.length = 0, h++), a = d.length, q !== a && (h++, e.length = q = a), b = 0; b < a; b++) e[b] !== e[b] && d[b] !== d[b] || e[b] === d[b] || (h++, e[b] = d[b]);
                            else {
                                e !== n && (e = n = {}, q = 0, h++);
                                a = 0;
                                for (b in d) d.hasOwnProperty(b) && (a++, e.hasOwnProperty(b) ? e[b] !== d[b] && (h++, e[b] = d[b]) : (q++, e[b] = d[b], h++));
                                if (q > a)
                                    for (b in h++, e) e.hasOwnProperty(b) && !d.hasOwnProperty(b) && (q--,
                                        delete e[b])
                            } else e !== d && (e = d, h++);
                        return h
                    }, function() {
                        ...
                        if (k)
                            if (U(d))
                                if (db(d)) {
                                    ...
                                    for (a in f = {}, d) yb.call(d, a) && (f[a] = d[a]);
                        else f = d
                    })
                },
                $digest: function() {
                    ...
                    do {
                        ...
                        for (N = this; h.length;) {
                            try {
                                G = h.shift(), G.scope.$eval(G.expression)
                            } catch (H) {
                                n.$$phase = null, e(H)
                            }
                            c = null
                        ...
                        a: do {
                            if (k = N.$$watchers)
                                for (q = k.length; q--;) try {
                                    if (d = k[q])
                                        if ((g =
                                                d.get(N)) !== (f = d.last) && !(d.eq ? ya(g, f) : "number" === typeof g && "number" === typeof f && isNaN(g) && isNaN(f))) z = !0, c = d, d.last = d.eq ? Ga(g, null) : g, d.fn(g, f === p ? g : f, N), 5 > s && (x = 4 - s, M[x] || (M[x] = []), C = O(d.exp) ? "fn: " + (d.exp.name || d.exp.toString()) : d.exp, C += "; newVal: " + sa(g) + "; oldVal: " + sa(f), M[x].push(C));
                                        else if (d === c) {
                                        z = !1;
                                        break a
                                    }
                        ...
                        if ((z || h.length) && !s--) throw n.$$phase = null,
                            a("infdig", b, sa(M));
                    } while (z || h.length);
                ...
                $destroy: function() {
                    if (!this.$$destroyed) {
                        ...
                        this.$$destroyed = !0;
                        this !== n && (q(this.$$listenerCount, zb(null, l, this)), a.$$childHead == this && (a.$$childHead = this.$$nextSibling), a.$$childTail == this && (a.$$childTail = this.$$prevSibling), this.$$prevSibling && (this.$$prevSibling.$$nextSibling = this.$$nextSibling), this.$$nextSibling && (this.$$nextSibling.$$prevSibling =
                            this.$$prevSibling), this.$parent = this.$$nextSibling = this.$$prevSibling = this.$$childHead = this.$$childTail = this.$root = null, this.$$listeners = {}, this.$$watchers = this.$$asyncQueue = this.$$postDigestQueue = [], this.$destroy = this.$digest = this.$apply = A, this.$on = this.$watch = function() {
                            return A
                        })
                    }
                },
    ...
    function ce() {
        this.$get = ["$window", "$document", function(b, a) {
            ...
            if (h) {
                ...
                p = !!("animation" in h || k + "Animation" in
                    h);
    ...
    function ta(b, a) {
        var c = b;
        P && (W.setAttribute("href", c), c = W.href);
        ...
        return function(b, a, c) {
            ...
            "function" !== d && (c = "boolean" === d && c ? function(a, b) {
                ...
                if (a && b && "object" === typeof a && "object" === typeof b) {
                    for (var d in a)
                        if ("$" !== d.charAt(0) && yb.call(a, d) && c(a[d], b[d])) return !0;
                    return !1
                }
                b = ("" + b).toLowerCase();
    ...
    function Mc(b, a, c, d, e) {
        ...
        if (h) 0 < e && (-1 < b && 1 > b) && (k = b.toFixed(e));
            ...
            if (f.length >=
                p + n)
                for (l = f.length - p, h = 0; h < l; h++) 0 === (l - h) % n && 0 !== h && (k += c), k += f.charAt(h);
    ...
    function Jc(b) {
        ...
        return function(c, e) {
            ...
            y(c) && (c = Ie.test(c) ? Z(c) : a(c));
            xb(c) && (c = new Date(c));
            if (!Oa(c)) return c;
            for (; e;)(m = Je.exec(e)) ? (f = f.concat(za.call(m, 1)), e = f.pop()) : (f.push(e), e = null);
            q(f, function(a) {
                k = Ke[a];
    ...
    function Oc(b, a, c, d) {
        function e(a, c) {
            c = c ? "-" + hb(c, "-") : "";
            d.removeClass(b, (a ? sb :
                tb) + c);
            d.addClass(b, (a ? tb : sb) + c)
        }
        var g = this,
            f = b.parent().controller("form") || ub,
            k = 0,
            m = g.$error = {},
            h = [];
        ...
        g.$setValidity = function(a, b, c) {
            var d = m[a];
            if (b) d && (Qa(d, c), d.length || (k--, k ||
                (e(b), g.$valid = !0, g.$invalid = !1), m[a] = !1, e(!0, a), f.$setValidity(a, !0, g)));
            else {
                k || e(b);
                if (d) {
                    if (-1 != Pa(d, c)) return
    ...
    function Le(b, a, c, d, e) {
        U(e) && (b.$$hasNativeValidators = !0, b.$parsers.push(function(g) {
            if (b.$error[a] || Pc(e, d) || !Pc(e, c)) return g;
            b.$setValidity(a, !1)
        }))
    }

    function wb(b, a, c, d, e, g) {
        var f = a.prop(Me),
            k = a[0].placeholder,
            m = {};
        d.$$validityState = f;
        ...
        var l = function(e) {
            if (!h) {
                var g = a.val();
                if (P && "input" === (e || m).type && a[0].placeholder !== k) k =
                    a[0].placeholder;
    ...
    var Ya = S.cache = {},
        ne = 1,
        ob = T.document.addEventListener ? function(b, a, c) {
            b.addEventListener(a, c, !1)
        } : function(b, a, c) {
            b.attachEvent("on" + a, c)
        },
        Xa = T.document.removeEventListener ? function(b, a, c) {
    ...
    var Ka = S.prototype = {
            ready: function(b) {
                ...
                var c = !1;
                "complete" === V.readyState ? setTimeout(a) : (this.on("DOMContentLoaded", a), S(T).on("load", a))
            },
            toString: function() {
                var b = [];
                q(this, function(a) {
    ...
    q({
        ...
        inheritedData: kb,
        scope: function(b) {
            return x(b).data("$scope") || kb(b.parentNode || b, ["$isolateScope", "$scope"])
        },
    ...
    q({
        ...
        S.prototype[c] = function(c, e, g) {
            for (var f, k = 0; k < this.length; k++) D(f) ? (f = a(this[k], c, e, g), B(f) && (f = x(f))) : Hb(f, a(this[k], c, e, g));
            return B(f) ? f : this
        };
    ...
    var qe = /^function\s*[^\(]*\(\s*([^\)]*)\)/m,
        ...
        Md = ["$provide", function(a) {
            ...
            this.register = function(c, d) {
                var e = c + "-animation";
                if (c && "." != c.charAt(0)) throw Oe("notcsel", c);
        ...
        readIdent: function() {
            ...
            if (cb.hasOwnProperty(c)) d.fn = cb[c], d.literal = !0, d.constant = !0;
                ...
                d.fn = E(function(a, c) {
                    ...
                    assign: function(d, e) {
                        return qb(d, c, e, a.text, a.options)
                    }
                })
            }
            this.tokens.push(d);
        ...
        readString: function(a) {
            ...
            for (var d = "", e = a, g = !1; this.index < this.text.length;) {
                var f = this.text.charAt(this.index),
                    e = e + f;
                if (g) "u" === f ? (f = this.text.substring(this.index + 1, this.index + 5), f.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + f + "]"), this.index += 4, d += String.fromCharCode(parseInt(f, 16))) : d = (g = Se[f]) ? d + g : d + f, g = !1;
                else if ("\\" === f) g = !0;
                else {
                    if (f === a) {
                        this.index++;
        ...
        fieldAccess: function(a) {
            ...
            return E(function(c, d, k) {
                ...
                assign: function(e, f, k) {
                    return qb(a(e, k), d, f, c.text, c.options)
                }
            })
        },
        ...
        functionCall: function(a, c) {
            ...
            return function(g, f) {
                ...
                if (h) {
                    ...
                    if (h === Qe || h === Re || Qc && h === Qc) throw ja("isecff", l);
                }
    ...
    var Nc = ".",
        ...
        Je = /((?:[^yMdHhmsaZE']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z))(.*)/,
        Ie = /^\-?\d+$/;
    Jc.$inject = ["$locale"];
    var Ge = $(I),
        He = $(Ha);
    ...
    var dd = $({
            ...
            compile: function(a, c) {
                8 >= P && (c.href || c.name || c.$set("href", ""), a.append(V.createComment("IE fix")));
                if (!c.href && !c.xlinkHref && !c.name) return function(a, c) {
                    var g = "[object SVGAnimatedString]" ===
                        xa.call(c.prop("href")) ? "xlink:href" : "href";
        ...
        Db[c] = function() {
            return {
                ...
                link: function(d, e, g) {
                    var f = a,
                        k = a;
                    "href" === a && "[object SVGAnimatedString]" === xa.call(e.prop("href")) && (k = "xlinkHref", g.$attr[k] = "xlink:href",
                        f = null);
    ...
    var Rc = function(a) {
        ...
        ed = Rc(),
        rd = Rc(!0),
        Te = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,
        Ue = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9-]+(\.[a-z0-9-]+)*$/i,
        Ve = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,
        Sc = {
            text: wb,
            number: function(a, c, d, e, g, f) {
                ...
                Le(e, "number", We, null, e.$$validityState);
            ...
            url: function(a, c, d, e, g, f) {
                wb(a, c, d, e, g, f);
                a = function(a) {
                    return ra(e, "url", e.$isEmpty(a) || Te.test(a), a)
                };
                e.$formatters.push(a);
                e.$parsers.push(a)
            },
            email: function(a, c, d, e, g, f) {
                wb(a, c, d, e, g, f);
                a = function(a) {
                    return ra(e, "email", e.$isEmpty(a) || Ue.test(a), a)
                };
                e.$formatters.push(a);
                e.$parsers.push(a)
            },
        ...
        Na = "ng-pristine",
        vb = "ng-dirty",
        Xe = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", function(a, c, d, e, g, f) {
            function k(a, c) {
                c = c ? "-" + hb(c, "-") : "";
                f.removeClass(e, (a ? sb : tb) + c);
                f.addClass(e, (a ? tb : sb) + c)
            }
            ...
            this.$setViewValue = function(d) {
                this.$viewValue = d;
                this.$pristine && (this.$dirty = !0, this.$pristine = !1, f.removeClass(e, Na), f.addClass(e, vb), l.$setDirty());
        ...
        Jd = function() {
            return {
                priority: 100,
                compile: function(a, c) {
                    return Ye.test(c.ngValue) ? function(a, c, g) {
                ...
                link: function(c, d, e, g, f) {
                    ...
                    c.$watch(e.ngIf, function(g) {
                        Sa(g) ? m || (m = c.$new(), f(m, function(c) {
                            ...
                            h = null), m && (m.$destroy(), m = null), k && (h = Cb(k.clone), a.leave(h, function() {
                            h = null
                        }), k = null))
                    })
                }
            ...
            return {
                ...
                link: function(e, g, f, k, m) {
                    ...
                    e.$watchCollection(k, function(a) {
                        ...
                        k = D.length = y.length;
                        for (f = 0; f < k; f++)
                            if (H = a === y ? f : y[f], v = a[H], v = p(H, v, f), Ba(v, "`track by` id"), B.hasOwnProperty(v)) A = B[v], delete B[v], u[v] =
                                A, D[f] = A;
                            else {
                                if (u.hasOwnProperty(v)) throw q(D, function(a) {
                                    a && a.scope && (B[a.id] = a)
                                }), d("dupes", h, v);
                                D[f] = {
                                    id: v
                        ...
                        for (k = y.length; f < k; f++) {
                            ...
                            G.$first = 0 === f;
                            G.$last = f === C - 1;
                            G.$middle = !(G.$first || G.$last);
                            G.$odd = !(G.$even = 0 === (f & 1));
                            A.scope || m(G, function(a) {
                                a[a.length++] = V.createComment(" end ngRepeat: " + h + " ");
                                c.enter(a, null, x(l));
                                l = a;
                                A.scope = G;
                                A.clone = a;
            ...
            return {
                ...
                link: function(e, f, k, m) {
                    function h(a, c, d, e) {
                        d.$render = function() {
                            var a = d.$viewValue;
                            e.hasOption(a) ? (y.parent() && y.remove(), c.val(a), "" === a && w.prop("selected", !0)) : D(a) && w ? c.val("") : e.renderUnknownOption(a)
                        };
                    ...
                    function l(a, c, d) {
                        ...
                        a.$watch(function() {
                            ya(e, d.$viewValue) || (e = la(d.$viewValue), d.$render())
                        });
                        c.on("change", function() {
                            a.$apply(function() {
                                var a = [];
                    ...
                    function p(e, f, g) {
                        function k() {
                            ...
                            if (r)
                                if (w && L(t))
                                    for (s = new Za([]), C = 0; C < t.length; C++) R[m] = t[C], s.put(w(e, R), t[C]);
                                else s = new Za(t);
                            for (C = 0; G = D.length,
                                C < G; C++) {
                                h = C;
                                ...
                                r ? d = B(s.remove(w ? w(e, R) : q(e, R))) : (w ? (d = {}, d[m] = t, d = w(e, d) === w(e, R)) : d = t === q(e, R), s = s || d);
                                E = l(e, R);
                                E = B(E) ? E : "";
                                h.push({
                                    id: w ? w(e, R) : n ? D[C] : C,
                            ...
                            for (D = c.length; R < D; R++) {
                                ...
                                y.length <= R ? (t = {
                                    ...
                                    f.append(t.element)) : (z = y[R], t = z[0], t.label != d && t.element.attr("label", t.label = d));
                                E = null;
                                C = 0;
                                for (G = h.length; C < G; C++) s = h[C], (d = z[C + 1]) ? (E = d.element, d.label !== s.label && E.text(d.label = s.label), d.id !== s.id && E.val(d.id = s.id), d.selected !== s.selected && E.prop("selected", d.selected = s.selected)) : ("" === s.id && v ? I = v : (I = u.clone()).val(s.id).prop("selected", s.selected).text(s.label), z.push({
                                    element: I,
                                    label: s.label,
                                    id: s.id,
                                    selected: s.selected
                            ...
                            for (; y.length >
                                R;) y.pop()[0].element.remove()
                        }
                        var h;
                        if (!(h = t.match(d))) throw Ze("iexp", t, ga(f));
                        var l = c(h[2] || h[1]),
                            m = h[4] || h[6],
                            n = h[5],
                            p = c(h[3] || ""),
                    ...
                    if (m[1]) {
                        ...
                        var r = k.multiple,
                            t = k.ngOptions,
                            v = !1,
                            w, u = x(V.createElement("option")),
                            A = x(V.createElement("optgroup")),
                            y = u.clone();
                        k = 0;
    ...
    T.angular.bootstrap ? console.log("WARNING: Tried to load angular more than once.") : ((Ca = T.jQuery) && Ca.fn.on ? (x = Ca, E(Ca.fn, {
        scope: Ka.scope,
        isolateScope: Ka.isolateScope,
        controller: Ka.controller,
        injector: Ka.injector,
        inheritedData: Ka.inheritedData
    }), Eb("remove", !0, !0, !1), Eb("empty", !1, !1, !1), Eb("html", !1, !1, !0)) : x = S, Ta.element = x, $c(Ta), x(V).ready(function() {
        Xc(V,
            cc)
    }))
})(window, document);
